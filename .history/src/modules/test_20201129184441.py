...
def test(row):
    return x333[(x333['city'] == row.city) & (x333['day'] == row.day) & (x333['mois'] == row.mois)][['amount']]

print(x2)
x2.amount = x2.assign(amount=lambda x: ((x['city'] == x333['city']) & (x['day'] == x333['day']) & (x['day'] == x333['day']))) 
print(x3)
print(x333)
