...
class Helper:
    ...
    def change_wrong_temperature_value(df):
        ...
        for index, row in df.iterrows():
            df_t = df_temperatures_drop_duplicate[
                        (df_temperatures_drop_duplicate['City'] == 'Tirana') 
                        & (df_temperatures_drop_duplicate['Month'] == 1) 
                        & (df_temperatures_drop_duplicate['Day'] == 1)
                    ]
