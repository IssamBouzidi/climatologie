...
pd.DatetimeIndex(['2016-01-01', '2016-01-02', '2016-01-03', '2016-01-04',
               '2016-01-05', '2016-01-06'],
              dtype='datetime64[ns]', name='dt', freq='D')

users = x['user'].unique()

pd.array(['a', 'b'], dtype=object)

idx = pd.MultiIndex.from_product((dates, users), names=['dt', 'user'])

pd.MultiIndex(levels=[['2016-01-01 00:00:00', '2016-01-02 00:00:00', '2016-01-03 00:00:00', '2016-01-04 00:00:00', '2016-01-05 00:00:00', '2016-01-06 00:00:00'], ['a', 'b']],
